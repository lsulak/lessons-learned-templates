  ...
  \cventry
    ...
    {October 2019 - October 2020} % Date(s)
    {
      \begin{cvitems}
      	...
      	\item {Our approach primarily involved Python and Spark-based data pipelines deployed to the AWS (using Datalake and adopting Lakehouse architecture), but some of our resources were deployed on-premises.}
